...
class NewIstekViewController: UIViewController {
    ...
    func setupLocationService() {
        ...
        let imageView = UIImageView(image: UIImage(named: "loc"))
...
//        print(currentUser)
        ...
        let waterRequest = WaterRequest(id: 77, initiator: currentUser, createdDate: dateString, availTill: "", latitude: mapView.camera.target.latitude, longitude: mapView.camera.target.longitude, requestType: selectedItem, additionalInfo: tesvirTextField.text ?? "")
